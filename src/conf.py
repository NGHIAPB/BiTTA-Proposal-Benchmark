...
COLORED_MNIST = {
    ...
    # 3 moi truong tao tu MNIST (COLOREDMNISTDataset.prepare_colored_mnist): train1 (20% dao mau),
    # train2 (10% dao mau), test (90% dao mau -> tuong quan mau-nhan bi dao nguoc). Chi 1 domain dich (test)
    # -> chi co Fully TTA.
    'file_path': './dataset/ColoredMNIST',
    'classes': ['digit<5', 'digit>=5'],
    'num_class': 2,
    'severity': None,
