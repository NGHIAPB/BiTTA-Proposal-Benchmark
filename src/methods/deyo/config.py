...
def _str2bool(v):
    # SUA: argparse type=bool coi MOI chuoi khong rong la True (ke ca "False"),
    # nen ban goc "--continual False" tren CLI van ra args.continual=True. Day la
    # loi co san trong repo goc cua DeYO (khong lien quan thuat toan) -- thay bang
    # parser chuoi dung nghia truoc khi cac gia tri nay duoc dung lam cong tac re
    # nhanh Fully TTA / Continuous trong main.py.
...
def get_args():
    ...
    parser.add_argument('--dset', default='ImageNet-C', type=str, help='ImageNet-C, Waterbirds, ColoredMNIST, CIFAR10-C, CIFAR100-C, TinyImageNet-C, PACS-scenario, ImageNetR-scenario, WaterBirds-scenario, ColoredMNIST-scenario')
    ...
    parser.add_argument('--debug', default=False, type=_str2bool, help='debug or not.')
    parser.add_argument('--continual', default=False, type=_str2bool, help='continual tta or fully tta')
    ...
    parser.add_argument('--if_shuffle', default=True, type=_str2bool, help='if shuffle the test set.')

    # corruption settings
    parser.add_argument('--level', default=5, type=int, help='corruption level of test(val) set.')
    parser.add_argument('--corruption', default='gaussian_noise', type=str, help='corruption type of test(val) set.')
    parser.add_argument('--unit', default='', type=str, help='(BO SUNG) chi chay 1 don vi (vd gaussian_noise-5, sketch) cua dataset *-C/PACS-scenario, dung cho Fully TTA moi don vi 1 tien trinh')
    ...
    parser.add_argument('--model', default='resnet50_bn_torch', type=str, help='resnet50_gn_timm or resnet50_bn_torch or vitbase_timm or resnet18_bn or resnet18_scenario (dung cho 5 dataset *-C/PACS/ImageNetR-scenario)')
